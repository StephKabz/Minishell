...
int						open_heredoc(char const *delim, int *out_fd, t_env **env);
...
int						env_set(t_env **env, char const *name, char const *value);
...
char					*path_from_dirs(char const *name, char **dirs, int *owned);
...
int						line_is_delim(char const *line, size_t line_len, char const *delim);
int						feed_line_buffer(char const *buf, ssize_t n, t_feed_ctx *ctx);
...
int						resolve_slash_command(char const *name, char **out_path, int *path_owned);
int						resolve_in_path(char const *name, t_env *env, char **out_path, int *path_owned);
int						resolve_command(char const *name, t_env *env, char **out_path, int *path_owned);
